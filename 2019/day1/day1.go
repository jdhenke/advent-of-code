...
func Part2(r io.Reader) (answer int, err error) {
	return day1(r, part2Fuel)
}

func day1(r io.Reader, fuelFunc func(int) int) (answer int, err error) {
...
func part1Fuel(mass int) int {
	return (mass / 3) - 2
}

func part2Fuel(mass int) int {
	out := 0
	for {
		fuel := part1Fuel(mass)
		if fuel < 0 {
