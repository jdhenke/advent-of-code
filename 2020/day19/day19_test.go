...
func TestPart1(t *testing.T) {
	tester.New(t, day19.Part1).Run(
		tester.FromString(testData1).Want(2),
		tester.FromString(testData2).Want(3),
...
func TestPart2(t *testing.T) {
	tester.New(t, day19.Part2).Run(
		tester.FromString(testData2).Want(12),
		tester.FromFile("input.txt").Want(386),
	)
}
